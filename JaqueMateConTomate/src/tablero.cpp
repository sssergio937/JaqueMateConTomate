...
void Tablero::inicializa_piezas(bool variante) {
    ...
    {
        // Fila 0: piezas rojas
        piezas[0][0] = new rey(Pieza::ROJO);
        piezas[0][0]->setPosicion(0, 0);
        piezas[0][1] = new reina(Pieza::ROJO);
        piezas[0][1]->setPosicion(1, 0);
        piezas[0][2] = new alfil(Pieza::ROJO);
        piezas[0][2]->setPosicion(2, 0);
        piezas[0][3] = new caballo(Pieza::ROJO);
        piezas[0][3]->setPosicion(3, 0);
        piezas[0][4] = new torre(Pieza::ROJO);
